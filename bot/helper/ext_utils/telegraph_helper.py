...
class TelegraphHelper:
    ...
    def edit_telegraph(self, path, telegraph_content):
        ...
        for content in telegraph_content :
            if nxt_page == 1 :
                content += f'<b><a href="https://telegra.ph/{path[nxt_page]}">Next ⏭️</a></b>'
                nxt_page += 1
            else :
                if prev_page <= num_of_path:
                    content += f'<b><a href="https://telegra.ph/{path[prev_page]}">⏮️ Prev</a></b>'
                    prev_page += 1
...
telegraph=TelegraphHelper('kamileecher', 'https://t.me/kamileecher')
